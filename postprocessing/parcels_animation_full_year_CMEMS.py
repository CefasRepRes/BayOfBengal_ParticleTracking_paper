...
fig_name = '/gpfs/home/rpe16nbu/projects/ocpp_mo1/plots/paper_data/BoB_all_countries_uniform_Cop_daily_Jun2018-Sept2019_full_year_fortnightly_cbfriendly.gif'
# set parameters
...
scat_Thai1 = ax.scatter(lon_p_Thai1[time_id_Thai1], lat_p_Thai1[time_id_Thai1],color='black', s=10)
...
scat_Thai2 = ax.scatter(lon_p_Thai2[time_id_Thai2], lat_p_Thai2[time_id_Thai2],color='black', s=10)
...
scat_Thai3 = ax.scatter(lon_p_Thai3[time_id_Thai3], lat_p_Thai3[time_id_Thai3],color='black', s=10)
...
# Save the animation
anim = FuncAnimation(fig, animate, interval=interval, frames=range(0, len(speed_subset)-1, 14), repeat=True) # interval is number of milliseconds between frames
...
fig.savefig("/gpfs/home/rpe16nbu/projects/ocpp_mo1/plots/paper_data/CMEMS_anim_still_cbfriendly", bbox_inches='tight', facecolor='white', transparent=False)
