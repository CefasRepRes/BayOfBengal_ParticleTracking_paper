...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/BoB_Indonesia_uniform_ROMS_daily_July2020.nc"

input_velocities_filepath = "/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/input/processed/paper_data/"

ufile = input_velocities_filepath+'ocean_velocities_u_ROMS_July2020_daily.nc'
vfile = input_velocities_filepath+'ocean_velocities_v_ROMS_July2020_daily.nc'
...
def MakeParticleSet(fieldset): # defining a function
        ...
        return ParticleSet.from_list(fieldset, BeachableParticles, # this returns an instance of the BeachableParticles class
                                     ...
                                     lon = lons_indonesia,
                                     lat = lats_indonesia,
                                     repeatdt=timedelta(hours=1)) # 18,480 particles in 14 days

				      
# WINDAGE
windage = 0.01
filenames_wind = {'U_wind': input_velocities_filepath + "windage_u_ROMS_interpolated_July2020_daily.nc",
                 'V_wind': input_velocities_filepath + "windage_v_ROMS_interpolated_July2020_daily.nc"}
...
# STOKES DRIFT
filenames_stokes = {'U_stokes': input_velocities_filepath + "stokes_u_ROMS_interpolated_July2020_daily_fromcoarse.nc",
                 'V_stokes': input_velocities_filepath + "stokes_v_ROMS_interpolated_July2020_daily_fromcoarse.nc"}
