...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/BoB_Bang_uniform_ROMS_daily_July2020.nc"
...
def MakeParticleSet(fieldset): # defining a function
        ...
        return ParticleSet.from_list(fieldset, BeachableParticles, # this returns an instance of the BeachableParticles class
                                     ...
                                     lon = lons_bangladesh,
                                     lat = lats_bangladesh,
                                     repeatdt=timedelta(hours=1)) # 13,440 particles in 14 days
