...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/BoB_Indonesia_uniform_ROMS_hourly_July2020.nc"

input_velocities_filepath = "/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/input/processed/paper_data/"

ufile = input_velocities_filepath+'ocean_velocities_ROMS_July2020_hourly.nc'

filenames = {'U': {'lon': ufile, 'lat': ufile, 'data': ufile},
             'V': {'lon': ufile, 'lat': ufile, 'data': ufile}}
...
# WINDAGE
windage = 0.01
filenames_wind = {'U_wind': input_velocities_filepath + "windage_u_ROMS_interpolated_July2020_hourly.nc",
                 'V_wind': input_velocities_filepath + "windage_v_ROMS_interpolated_July2020_hourly.nc"}
...
# STOKES DRIFT
filenames_stokes = {'U_stokes': input_velocities_filepath + "stokes_u_ROMS_interpolated_July2020_hourly_fromcoarse.nc",
                 'V_stokes': input_velocities_filepath + "stokes_v_ROMS_interpolated_July2020_hourly_fromcoarse.nc"}
