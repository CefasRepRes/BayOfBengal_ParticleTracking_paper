...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/BoB_India_uniform_ROMS_daily_July2020.nc"
...
def MakeParticleSet(fieldset): # defining a function
        ...
        return ParticleSet.from_list(fieldset, BeachableParticles, # this returns an instance of the BeachableParticles class
                                     ...
                                     lon = lons_india,
                                     lat = lats_india,
                                     repeatdt=timedelta(hours=1)) # 53,424 particles in 14 days
