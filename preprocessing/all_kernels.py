...
#    Taken from source code in Parcels docs but adapted following Delandmeteri et al. 2019 North Sea example.
...
#    Taken from source code in Parcels docs.
...
# adapted from Delandmeter et al. 2019 North Sea Examples
