...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/BoB_Indonesia_uniform_ROMS_daily_Oct2018-Sept2019_postmonsoon.nc"

input_velocities_filepath = "/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/input/processed/paper_data/"

ufile = input_velocities_filepath+'ocean_velocities_u_ROMS_Oct2018-Sept2019_daily.nc'
vfile = input_velocities_filepath+'ocean_velocities_v_ROMS_Oct2018-Sept2019_daily.nc'
...
# WINDAGE
windage = 0.01
filenames_wind = {'U_wind': input_velocities_filepath + "windage_u_ROMS_interpolated_Oct2018-Oct2019_daily.nc",
                 'V_wind': input_velocities_filepath + "windage_v_ROMS_interpolated_Oct2018-Oct2019_daily.nc"}
...
# STOKES DRIFT
filenames_stokes = {'U_stokes': input_velocities_filepath + "stokes_u_ROMS_interpolated_Oct2018-Oct2019_daily_fromcoarse.nc",
                 'V_stokes': input_velocities_filepath + "stokes_v_ROMS_interpolated_Oct2018-Oct2019_daily_fromcoarse.nc"}
...
pset.execute(k_AdvectionRK4 + k_DiffusionUniformKh + k_Windage + k_StokesDrift + k_BeachedStatusCheck + k_BeachedDelete,
	     runtime=timedelta(days=123), # 4 months with repeated release of particles
