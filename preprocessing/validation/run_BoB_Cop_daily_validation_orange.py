...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/validation/BoB_Cop_daily_validation_orange.nc"

input_velocities_filepath = "/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/input/processed/paper_data/validation/"

filenames = {'U': input_velocities_filepath + "ocean_velocities_Cop_Jun-July2019_daily_validation_orange.nc",
             'V': input_velocities_filepath + "ocean_velocities_Cop_Jun-July2019_daily_validation_orange.nc"}
...
# WINDAGE
windage = 0.01
filenames_wind = {'U_wind': input_velocities_filepath + "windage_u_avgd_interpolated_Jun-Jul2019_daily_validation_orange.nc",
                 'V_wind': input_velocities_filepath + "windage_v_avgd_interpolated_Jun-Jul2019_daily_validation_orange.nc"}
...
# STOKES DRIFT
filenames_stokes = {'U_stokes': input_velocities_filepath + "stokes_u_avgd_interpolated_Jun-Jul2019_daily_fromcoarse_validation_orange.nc",
                 'V_stokes': input_velocities_filepath + "stokes_v_avgd_interpolated_Jun-Jul2019_daily_fromcoarse_validation_orange.nc"}
...
pset.execute(k_AdvectionRK4 + k_DiffusionUniformKh + k_Windage + k_StokesDrift + k_BeachedStatusCheck + k_BeachedDelete,
	     runtime=timedelta(days=43), # June-Sept with repeated release of particles
