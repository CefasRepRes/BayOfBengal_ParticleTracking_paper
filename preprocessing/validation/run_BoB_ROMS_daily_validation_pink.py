...
output_filename="/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/output/paper_data/validation/BoB_ROMS_daily_validation_pink.nc"

input_velocities_filepath = "/gpfs/home/rpe16nbu/projects/ocpp_mo1/data/input/processed/paper_data/validation/"

ufile = input_velocities_filepath+'ocean_velocities_u_ROMS_Aug-Oct2018_daily_validation_pink.nc'
vfile = input_velocities_filepath+'ocean_velocities_v_ROMS_Aug-Oct2018_daily_validation_pink.nc'
...
# WINDAGE
windage = 0.01
filenames_wind = {'U_wind': input_velocities_filepath + "windage_u_ROMS_interpolated_Aug-Oct2018_daily_validation_pink.nc",
                 'V_wind': input_velocities_filepath + "windage_v_ROMS_interpolated_Aug-Oct2018_daily_validation_pink.nc"}
...
# STOKES DRIFT
filenames_stokes = {'U_stokes': input_velocities_filepath + "stokes_u_ROMS_interpolated_Aug-Oct2018_daily_fromcoarse_validation_pink.nc",
                 'V_stokes': input_velocities_filepath + "stokes_v_ROMS_interpolated_Aug-Oct2018_daily_fromcoarse_validation_pink.nc"}
...
pset.execute(k_AdvectionRK4 + k_DiffusionUniformKh + k_Windage + k_StokesDrift + k_BeachedStatusCheck + k_BeachedDelete,
	     runtime=timedelta(days=64), # 4 months with repeated release of particles
